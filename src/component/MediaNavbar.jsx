  ...
  return (
    <div>
      <nav class="bg-white border-gray-200">
        <div class="text-primary max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2">
            <div class="relative">
              ...
              <input
                type="text"
                id="search-navbar"
                class="block w-full p-2 pl-10 text-sm border border-gray-300 bg-gray-50 focus:ring-primary focus:border-primary"
                placeholder="Search..."
              />
            </div>
          </div>
          ...
          >
            <div class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <NavLink to="/videos/short-messages" class="block py-2 pl-3 pr-4">
                Short Messages
              </NavLink>
              <NavLink to="/videos/stream-service" class="block py-2 pl-3 pr-4">
                Stream Service
              </NavLink>
            </div>
          </div>
