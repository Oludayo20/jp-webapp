...
import { useAddDepartmentMutation } from '../redux/slice/departmentApi';
...
const AddMinistry = () => {
  ...
  const [addDepartment, { data, isLoading, isSuccess, isError, error }] =
  ...
  const handleSubmit = async (e) => {
    ...
    if (ministryData.name == '' || ministryData.description == '') {
      toast.error('name and description field required');
    } else {
      console.log(ministryData);
      await addDepartment(ministryData);
    }
  };
