...
import { useAddMediaMutation } from '../redux/slice/mediaApi';
...
const AddMedias = () => {
  ...
  const [addMedia, { data, isLoading, isSuccess, isError, error }] =
    useAddMediaMutation();
        ...
        <div className="flex space-x-5 mt-3">
          <div className="w-1/2">
            ...
            <select
              ...
              id="countries"
              className="bg-gray-50 border border-primary text-primary text-sm focus:ring-primary focus:border-primary block w-full p-2.5"
            >
              <option selected>Choose a category</option>
              <option value="Father's Blessing">Father's Blessing</option>
              <option value="Short Message">Short Message</option>
            </select>
          </div>
          <div className="w-1/2">
            <label
            ...
            <select
              name="speaker"
              value={mediaData.speaker}
              onChange={handleChange}
              id="countries"
              className="bg-gray-50 border border-primary text-primary text-sm focus:ring-primary focus:border-primary block w-full p-2.5"
            >
              <option selected>Choose a speaker</option>
              <option value="PBA">PBA</option>
              <option value="Pastor Ope">Pastor Ope</option>
              <option value="Pastor Ton">Pastor Tony</option>
              <option value="Pastor Odinaka">Pastor Odinaka</option>
            </select>
          </div>
        </div>
